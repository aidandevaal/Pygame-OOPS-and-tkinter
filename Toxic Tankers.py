...
class enemy(object):                     #Enemy setup
        ...
        def draw(self,win):                     #Zombie1 boundaries/increased move speed/hitbox
                ...
                if self.visible:
                        ...
                        pygame.draw.rect(win, (0,128,0), (self.hitbox[0], self.hitbox[1] - 20, 50 - (5 * (4 - self.lives)), 10))
                        self.hitbox = (self.x + 17, self.y + 2, 31, 57)
        ...
        def draw2(self,win):                     #Zombie2 boundaries/increased move speed/hitbox
                ...
                if self.visible:
                        ...
                        pygame.draw.rect(win, (255,0,0), (self.hitbox[0], self.hitbox[1] - 20, 50, 10))
                        pygame.draw.rect(win, (0,128,0), (self.hitbox[0], self.hitbox[1] - 20, 50 - (5 * (5 - self.lives)), 10))
                        self.hitbox = (self.x + 17, self.y + 2, 31, 57)
